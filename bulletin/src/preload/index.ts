...
const api = {
  ...
  create_schedule: (userId: string, title: string, date: string, endDate: string | null, allDay: boolean, startTime: string | null, endTime: string | null, repeatWeekly: boolean, repeatMonthly: boolean, memo: string | null, color: string): Promise<void> =>
    ipcRenderer.invoke('schedule:create', userId, title, date, endDate, allDay, startTime, endTime, repeatWeekly, repeatMonthly, memo, color),
